...
import { Snackbar, Alert, Box, LinearProgress, Typography, IconButton, Stack, Paper } from '@mui/material';
import CloseIcon from '@mui/icons-material/Close';
import { remove, setStatus } from '@/redux/features/uploadQueueSlice';
